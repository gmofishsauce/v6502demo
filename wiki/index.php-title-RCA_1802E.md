...
- [6. REG\_DB\_EN, REG\_OUT\_EN](#6-regdben-regouten)
- [7. NOUTEN](#7-nouten)
- [8. /LD\_IN, /N\_TO\_RAB, /IN\_RESET, INTDB0~INTDB7](#link-could-not-be-patched)
- [9. /SET\_P1X2, /P\_RAB\_OUT, /X\_RAB\_OUT, /LD\_X, /LD\_P, LD\_FR\_DB, LD\_FR\_N](#9-setp1x2-prabout-xrabout-ldx-ldp-ldfrdb-ldfrn)
- [10. /LD\_T\_FR\_PX, LD\_T\_FR\_PX, /T\_OUT\_EN](#10-ldtfrpx-ldtfrpx-touten)
- [11. /D\_ZERO, D\_SHIFT\_IN, /D\_SHIFT, D\_OUT\_EN, D\_SHIFT\_OUT](#11-dzero-dshiftin-dshift-douten-dshiftout)
- [12. B\_SHIFT\_OUT, B\_OUT\_EN, /B\_SHIFT, /LD\_B](#12-bshiftout-bouten-bshift-ldb)
- [13. EXT\_DB\_IN, EXT\_DB\_OUT](#13-extdbin-extdbout)
