...
See our main site for 
[some more information and images.](http://www.visual6502.org/images/pages/RCA_1802_die_shots.html)
...
- [1 Control Logic](#control-logic)
- [2 Datapath](#datapath)
- [2.1 1. /ARO, /ALO](#1.-.2faro.2c-.2falo)
- [2.2 2. REGWL, REGWR](#2.-regwl.2c-regwr)
- [2.3 3. /REGRL, /REGRR](#3.-.2fregrl.2c-.2fregrr)
- [2.4 4. /EF1234, SELREG0, SELREG2, and REGSEL](#4.-.2fef1234.2c-selreg0.2c-selreg2.2c-and-regsel)
- [2.5 5. DEC, COUT, CIN](#5.-dec.2c-cout.2c-cin)
- [2.6 6. REG\_DB\_EN, REG\_OUT\_EN](#6.-reg-db-en.2c-reg-out-en)
- [2.7 7. NOUTEN](#7.-nouten)
- [2.8 8. /LD\_IN, /N\_TO\_RAB, /IN\_RESET, INTDB0~INTDB7](#8.-.2fld-in.2c-.2fn-to-rab.2c-.2fin-reset.2c-intdb0.7eintdb7)
- [2.9 9. /SET\_P1X2, /P\_RAB\_OUT, /X\_RAB\_OUT, /LD\_X, /LD\_P, LD\_FR\_DB, LD\_FR\_N](#9.-.2fset-p1x2.2c-.2fp-rab-out.2c-.2fx-rab-out.2c-.2fld-x.2c-.2fld-p.2c-ld-fr-db.2c-ld-fr-n)
- [2.10 10. /LD\_T\_FR\_PX, LD\_T\_FR\_PX, /T\_OUT\_EN](#10.-.2fld-t-fr-px.2c-ld-t-fr-px.2c-.2ft-out-en)
- [2.11 11. /D\_ZERO, D\_SHIFT\_IN, /D\_SHIFT, D\_OUT\_EN, D\_SHIFT\_OUT](#11.-.2fd-zero.2c-d-shift-in.2c-.2fd-shift.2c-d-out-en.2c-d-shift-out)
- [2.12 12. B\_SHIFT\_OUT, B\_OUT\_EN, /B\_SHIFT, /LD\_B](#12.-b-shift-out.2c-b-out-en.2c-.2fb-shift.2c-.2fld-b)
- [2.13 13. EXT\_DB\_IN, EXT\_DB\_OUT](#13.-ext-db-in.2c-ext-db-out)
 [3 Simple logic gates](#simple-logic-gates)
 [4 NOR4 layout](#nor4-layout)
...
](http://visual6502.org/wiki/images/6/64/Rca1802-control-reversed.gif)
...
](http://visual6502.org/wiki/images/6/62/1802_dpth.png)
...
have a stronger drive than the storage inverters. The datapath analysis at 
[http://home.earthlink.net/~schultdw/1802/datapath/index.html](http://home.earthlink.net/~schultdw/1802/datapath/index.html) suggests that the 
...
-  Manuals at 
[decodesystems.com](http://www.decodesystems.com/cosmac/index.html#cdp1802) and at 
[bitsavers](http://bitsavers.informatik.uni-stuttgart.de/pdf/rca/cosmac/)
-  
...
-  The 
[1802 Cosmicos](http://retro.hansotten.nl/index.php?page=1802-cosmicos) Single board computer by Bob Stuurman of Radio Bulletin (website by Hans Otten)
