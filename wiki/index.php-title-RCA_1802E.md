...
- [Datapath](#datapath)
- [1. /ARO, /ALO](#aroalo)
- [2. REGWL, REGWR](#2regwlregwr)
- [3. /REGRL, /REGRR](#3regrlregrr)
- [4. /EF1234, SELREG0, SELREG2, and REGSEL](#4ef1234selreg0selreg2andregsel)
- [5. DEC, COUT, CIN](#5deccoutcin)
- [6. REG\_DB\_EN, REG\_OUT\_EN](#6regdbenregouten)
- [7. NOUTEN](#7nouten)
- [8. /LD\_IN, /N\_TO\_RAB, /IN\_RESET, INTDB0~INTDB7](#8ldinntorabinresetintdb0tintdb7)
- [9. /SET\_P1X2, /P\_RAB\_OUT, /X\_RAB\_OUT, /LD\_X, /LD\_P, LD\_FR\_DB, LD\_FR\_N](#9setp1x2praboutxraboutldxldpldfrdbldfrn)
- [10. /LD\_T\_FR\_PX, LD\_T\_FR\_PX, /T\_OUT\_EN](#10ldtfrpxldtfrpxtouten)
- [11. /D\_ZERO, D\_SHIFT\_IN, /D\_SHIFT, D\_OUT\_EN, D\_SHIFT\_OUT](#11dzerodshiftindshiftdoutendshiftout)
- [12. B\_SHIFT\_OUT, B\_OUT\_EN, /B\_SHIFT, /LD\_B](#12bshiftoutboutenbshiftldb)
- [13. EXT\_DB\_IN, EXT\_DB\_OUT](#13extdbinextdbout)
- [Simple logic gates](#simplelogicgates)
- [NOR4 layout](#nor4layout)
- [Resources](#resources)
